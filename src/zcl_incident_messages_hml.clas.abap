CLASS zcl_incident_messages_hml DEFINITION
  PUBLIC
  ...
  PUBLIC SECTION.
    ...
    CONSTANTS:
      gc_msgid TYPE symsgid VALUE 'ZMC_INCT_MESSAGE_HML',

      BEGIN OF status_invalid,
        msgid TYPE symsgid VALUE 'ZMC_INCT_MESSAGE_HML',
      ...
      BEGIN OF enter_inc_desc,
        ...
        attr3 TYPE scx_attrname VALUE '',
        attr4 TYPE scx_attrname VALUE '',
      END OF enter_inc_desc,

      BEGIN OF enter_inc_prio,
        msgid TYPE symsgid VALUE 'ZMC_INCT_MESSAGE_HML',
    ...
    METHODS constructor
      IMPORTING
        ...
        status                TYPE zde_status_hml OPTIONAL
...
CLASS zcl_incident_messages_hml IMPLEMENTATION.
